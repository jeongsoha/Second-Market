...
<!-- second로고 -->
   ...
   <div class="header_area" id="h1">
      <h1><a href="/second/shop/goods/goodsList.jsp" title="second#"><img class="main_image" src="<c:url value="/resources/images/second.png"/>" style="margin-left: 200px; display: block;" alt="second#"/></a></h1>   
   </div>
